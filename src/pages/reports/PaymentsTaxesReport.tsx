  ...
  return (
    <div className="space-y-6 w-full font-sans">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
        {cards.map((card, idx) => (
          <div key={idx} className={`rounded-xl p-4 bg-white border flex flex-col justify-between shadow-sm min-h-[135px] ${card.border ? 'border-red-200 bg-red-50/5' : 'border-gray-100'}`}>
